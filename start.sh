...
sed -i "s|{REGION}|$REGION|g; s|{BUCKET4FETCHER}|$BUCKET4FETCHER|g; s|{BUCKET4EMITTER}|$BUCKET4EMITTER|g; s|{ACCESS_KEY}|$ACCESS_KEY|g; s|{SECRET_KEY}|$SECRET_KEY|g; s|{S3_ENTRYPOINT}|$S3_ENTRYPOINT|g;" ${CONFIG_PATH}/config.xml
